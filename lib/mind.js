...
function generateResponseForWQType(wqtype, inputArray) {
     switch(wqtype) {
         ...
         case 'whose':
              ...
              break;
         case 'what':
             return storage.what_q[getRandomInt(0,storage.what_q.lenth-1)]
             break;
         case 'where':
             return storage.where_q[getRandomInt(0,storage.where_q.lenth-1)]
             break;
         case 'when':
             return storage.when_q[getRandomInt(0,storage.when_q.lenth-1)]
             break;
         default:
